...
public class FXMLMateriasController {
    ...
    void initialize() {
        ...
        creditosTableColumn.setCellValueFactory(new PropertyValueFactory<>("creditos"));
        horasTeoricasTableColumn.setCellValueFactory(new PropertyValueFactory<>("horasTeoricas"));
        horasPracticasTableColumn.setCellValueFactory(new PropertyValueFactory<>("horasPracticas"));
    ...
    /**
     * Permite agregar una nueva materia a la tabla
     * de materias.
     * @return el evento
     */
    ...
    /**
     * Permite editar una materia seleccionado de
     * la tabla de materias, asignando sus datos al
    ...
    /**
     * Permite guardar los cambios del formulario de materia despues
     * de haber seleccionado una materia a editar.
     * @return el evento
     */
    private EventHandler<ActionEvent> guardarButtonHandler(){
        return new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                materiasTableView.getItems().add(materiaSelected);
    ...
    /**
     * Permite guardar los datos de la tabla de materias
     * en la base de datos.
     * @return el evento
     */
    ...
    /**
     * Permite cargar los datos de los alumnos
